...
export async function runMigrations() {
  ...
  try {
    ...
    const migrationFiles = ['001_computer_core_schema.sql', '002_ai_browser_schema.sql', '003_smart_work_calendar_schema.sql', '004_core_user_schema.sql', '005_ai_computer_os_core.sql'];
